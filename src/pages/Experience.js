      ...
      <VerticalTimeline lineColor='#444444'>
        ...
        <VerticalTimelineElement 
         ...
         icon={<SchoolIcon />}>
          ...
          <p>⭐️ 1 year foreign philology (English & Chinese) </p>
         </VerticalTimelineElement>
         ...
         icon={<SchoolIcon />}>
          ...
          <h4 className='vertical-timeline-element-subtitle'>🇺🇦 Kharkiv UA</h4>
          <p>⭐️ Bachelor's degree in hotel, resort and tourist service management </p>
         </VerticalTimelineElement>
         ...
         icon={<OutdoorGrillIcon />}>
          ...
          <h4 className='vertical-timeline-element-subtitle'>🇺🇦 Kharkiv UA</h4>
          <p>⭐️ Worked as a Bartender (2 month) and Chef (8 month) </p>
         </VerticalTimelineElement>
         ...
         icon={<LocalShippingIcon />}>
          ...
          <h4 className='vertical-timeline-element-subtitle'>🇺🇦 Kharkiv UA</h4>
          <p>⭐️ Currently working as Logistics Coordinator (USA trucking)  </p>
         </VerticalTimelineElement>
